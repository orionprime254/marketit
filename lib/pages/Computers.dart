...
class _ComputersPageState extends State<ComputersPage>with WidgetsBindingObserver {
  ...
  Future<void> _initStream() async {
    ...
    setState(() {
      ...
      _stream = FirebaseFirestore.instance
          .collection('uploads')
          .where('Category', isEqualTo: 'Computers & Hardware')
                      ...
                      return GridView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return GestureDetector(
                              ...
                              child: ProductContainer(imageUrls: imageUrls, thisItem: thisItem, itemId: itemId,
